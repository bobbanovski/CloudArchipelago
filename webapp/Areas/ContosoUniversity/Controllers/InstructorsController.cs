    ...
    public class InstructorsController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            Instructor instructor = db.Instructors
                ...
                .Where(i => i.ID == id)
                .Single();
            instructor.OfficeAssignment = null; //removes assignment of instructor to office
            ...
            if (department != null)
            {
                department.InstructorID = null; //removes assignment of instructor to department
            }
